...
export async function getStaticProps({ locale }: { locale: string }) {
  ...
  return {
    props: {
      ...(await serverSideTranslations(locale, ["react"], null, ["br", "en"])),
    },
  };
}
        ...
        <Section width="1100px" paddingRight="270px">
          <Flex column justifyCenter fullHeight>
            ...
            >
              ...
              />
              <path
                d="M93.1539 24.7371H96.5397L143.228 94.2297L123.934 68.6308L95.9857 28.0568L95.8626 68.6308H93.1539V24.7371Z"
                style={{ fill: "var(--primary-color)" }}
              />
              <path
            ...
            <Flex columnOnMobile>
              <Project>
                ...
                <ProjectDescription>
                  <Title
                    medium
                    style={{ marginRight: 15, marginBottom: 20, maxWidth: 280 }}
                  >
